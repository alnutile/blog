            ...
            <div class="span10">
                <div class="span8 home-intro">
                    <div class="row-fluid">
                        <h3>Who?</h3>
                        <p>
                            <span class="dropcap dark">A</span>lfred Nutile 15+ years in the tech industry. Focused on building RESTful APIs in Laravel/PHP, and building apps in AngularJS.
                        </p>
                        <p>
                            Resume
                        ...
                        <p>
                            <a class="btn btn-default btn-inverse" href='http://www.developershangout.io/'>
                                <i class="fa fa-icon-headphones"></i> &nbsp;DevelopersHangout Podcast!
                            </a>
                        </p>
                    </div>
                    <div class="row-fluid">
